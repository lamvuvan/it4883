...
public class Kafka {
    ...
    public static final String ACK_CONFIG ="all";
//    public static final String VALUE_SERIALIZER_CONFIG = LogSerializer.class.getName();
    ...
    public static final String VALUE_DESERIALIZER_CONFIG = "org.apache.kafka.common.serialization.StringDeserializer";
